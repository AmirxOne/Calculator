...
// const numberPrint = document.querySelectorAll(".number-print");
//
...
// function clearone() {
//    let text = answer.innerHTML;
//    if (text.length === 1){
//        answer.innerHTML = 0
//    }else {
//        answer.innerHTML = text.substring(0, text.length-1)
//    }
// }
//
//
